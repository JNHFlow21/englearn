	...
	var body: some View {
		ScrollView {
			VStack(alignment: .leading, spacing: Theme.sectionSpacing) {
				...
				Card(title: "API Key", systemImage: "key") {
					VStack(alignment: .leading, spacing: 10) {
				...
				Card(title: "Privacy", systemImage: "hand.raised") {
				...
				Card(title: "Style", systemImage: "slider.horizontal.3") {
					VStack(alignment: .leading, spacing: 10) {
				...
				Card(title: "Glossary", systemImage: "text.book.closed") {
					VStack(alignment: .leading, spacing: 8) {
